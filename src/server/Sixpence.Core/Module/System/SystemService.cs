...
using Sixpence.Core.Module.Vertification.Mail;
...
using Sixpence.Core.Module.System;
using Sixpence.Core.Module.System.Models;
using Sixpence.Core.Auth.Github;
using Sixpence.Core.Auth.Gitee;

namespace Sixpence.Core.Module.DataService
{

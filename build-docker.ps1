...
docker build -f ".\src\server\Sixpence.WeChat\Dockerfile" --force-rm -t carldu/wechat-server:latest --label "com.microsoft.created-by=visual-studio" --label "com.microsoft.visual-studio.project-name=Sixpence.WeChat" ".\src\server"
Write-Success-Message "OK."


Write-Section-Message "Build html pc"
docker build -f ".\src\client_pc\Dockerfile" -t carldu/wechat-html-pc:latest ".\src\client_pc"
Write-Success-Message "OK."
